...
from cryptvault.cli.formatters import format_error, format_info
...
def setup_logging(verbose: bool = False):
    ...
    logging.basicConfig(
        ...
        handlers=[logging.StreamHandler(), logging.FileHandler("logs/cryptvault.log")],
    )
...
Aliases:
  ...
  -v, --verbose     Verbose output
    ...
    parser.add_argument(
        "--compare", nargs="+", metavar="SYMBOL", help="Compare multiple assets: BTC ETH ADA"
    )
    parser.add_argument("--live", metavar="SYMBOL", help="Start live analysis for symbol")
    parser.add_argument(
        "--desktop", "-d", action="store_true", help="Open desktop charts in new window"
    )
    parser.add_argument(
        "--accuracy", action="store_true", help="Show ML prediction accuracy report"
    )
    ...
    parser.add_argument(
        "--no-chart", action="store_true", help="Disable automatic chart generation"
    )
    parser.add_argument(
        "--save-chart",
        metavar="PATH",
    ...
    # Version
    parser.add_argument("--version", action="version", version=f"CryptVault {__version__}")
