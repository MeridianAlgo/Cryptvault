...
def get_version():
    ...
    version_file = os.path.join(os.path.dirname(__file__), "cryptvault", "__version__.py")
...
setup(
    ...
    author_email="contact@meridianalgo.org",
    ...
    packages=find_packages(
        where=".", include=["cryptvault*"], exclude=["tests*", "docs*", "examples*", "scripts*"]
    ),
    classifiers=[
