...
from .linear_models import ARIMAPredictor, LinearPredictor
...
class AdvancedEnsembleModel:
    ...
    def train(
        self, features: np.ndarray, targets: np.ndarray, price_data: Optional[PriceDataFrame] = None
    ) -> bool:
        """
    ...
    def get_model_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "model_scores": (
                self.model_performance.copy() if hasattr(self, "model_performance") else {}
            ),
            "model_weights": self.get_model_contributions(),
