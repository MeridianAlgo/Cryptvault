...
class PatternOverlay:
    ...
    def _draw_triangle_pattern(
        self, pattern: Dict, dates: list, highs: list, lows: list, color: str, alpha: float
    ):
        ...
        if "ascending" in pattern_type:
            ...
            self.ax.plot(
                [pattern_dates[0], pattern_dates[-1]],
    ...
    def _draw_flag_pattern(
        ...
        if pole_end > 0:
            self.ax.plot(
                [pattern_dates[0], pattern_dates[pole_end]],
    ...
    def _draw_double_triple_pattern(
        self, pattern: Dict, dates: list, highs: list, lows: list, color: str, alpha: float
    ):
        ...
        if extrema_idx:
            ...
            self.ax.scatter(
                extrema_dates, extrema_prices, color=color, s=100, alpha=alpha, marker="o", zorder=5
            )
    ...
    def _draw_divergence_pattern(
        self, pattern: Dict, dates: list, closes: list, color: str, alpha: float
    ):
        ...
        if "bullish" in pattern_type:
            ...
            self.ax.annotate(
                "",
                xy=(pattern_dates[-1], pattern_closes[-1]),
    ...
    def _draw_diamond_pattern(
        ...
        self.ax.plot(
            [pattern_dates[0], pattern_dates[mid_idx]],
        ...
        self.ax.plot(
            [pattern_dates[mid_idx], pattern_dates[-1]],
    ...
    def _draw_generic_pattern(
        self, pattern: Dict, dates: list, key_levels: Dict, color: str, alpha: float
    ):
