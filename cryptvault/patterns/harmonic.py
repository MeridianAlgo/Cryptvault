...
class HarmonicPatternDetector(BasePatternDetector):
    ...
    def _check_gartley(
        self, data: PriceDataFrame, points: List[PeakTrough], sensitivity: float
        ...
        if (
            0.568 <= AB_retracement <= 0.668  # B at 0.618 of XA
            and 0.332 <= BC_retracement <= 0.936  # C between 0.382-0.886 of AB
            and 0.736 <= CD_retracement <= 0.836
        ):  # D at 0.786 of XA
    ...
    def _check_butterfly(
        ...
        if (
            0.736 <= AB_retracement <= 0.836  # B at 0.786 of XA
            and 0.332 <= BC_retracement <= 0.936  # C between 0.382-0.886 of AB
            and 1.17 <= XA_extension <= 1.718
        ):  # D extends 1.27-1.618 of XA
    ...
    def _check_bat(
        ...
        # Check Bat ratios
        if (
            0.332 <= AB_retracement <= 0.55  # B between 0.382-0.5 of XA
            and 0.332 <= BC_retracement <= 0.936  # C between 0.382-0.886 of AB
            and 0.836 <= CD_retracement <= 0.936
        ):  # D at 0.886 of XA
    ...
    def _check_crab(
        ...
        # Check Crab ratios
        if (
            0.332 <= AB_retracement <= 0.668  # B between 0.382-0.618 of XA
            and 0.332 <= BC_retracement <= 0.936  # C between 0.382-0.886 of AB
            and 1.568 <= XA_extension <= 1.668
        ):  # D at 1.618 of XA
